...
- chosen_k: 4
- silhouette(chosen_k): 0.0706

### Churn rate by cluster (analysis only)

- cluster 2: churn_rate=0.1973, n=664
- cluster 1: churn_rate=0.1648, n=704
- cluster 3: churn_rate=0.1226, n=669
- cluster 0: churn_rate=0.0938, n=629
...
- K-Means separates the training set into clusters with churn rates ranging from 0.0938 to 0.1973.
